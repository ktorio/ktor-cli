...
private val RW_PERMISSIONS = (S_IWOTH or S_IROTH or S_IRUSR or S_IWUSR or S_IRGRP or S_IWGRP).toUShort()
private val RWE_PERMISSIONS = RW_PERMISSIONS or S_IEXEC.toUShort()
